...
test('QD-005 should have Docs page', { tag: '@playwright' }, async ({ page }) => {
...
test('QD-006 should switch documentation to Java Language', { tag: '@playwright' }, async ({ page }) => {
  await page.goto('https://playwright.dev/');
...
test('QD-007 should open GitHub repo', { tag: '@playwright' }, async ({ page }) => {
  await page.goto('https://playwright.dev/');
...
test('QD-008 should search documentation by method name', { tag: '@playwright' }, async ({ page }) => {
  await page.goto('https://playwright.dev/');
